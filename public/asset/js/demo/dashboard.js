var handleVectorMap = function () {
    ...
    if ($('#world-map').length !== 0) {
        var fillColor = ($('#world-map').attr('data-theme') == 'transparent')
            ? 'rgba(' + app.color.whiteRgb + ', .25)'
            : app.color.gray600;
        $('#world-map').vectorMap({
            map: 'world_mill',
            scaleColors: [
                app.color.gray300, app.color.gray600
            ],
    ...
    setTimeout(function () {
        $
            ...
            .add({
                ...
                text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempus lacus ut l' +
                            'ectus rutrum placerat.',
